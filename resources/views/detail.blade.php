    ...
    <form action="{{url('detail')}}" method="post" id="formvalidate">
        ...
        <div class="card mt-5">
            ...
            <div class="card-body">
                ...
                <div class="row my-5">
                    ...
                    <div class="col-md-6 my-3">
                        ...
                        <input type="number" name="verification_code" required class="form-control"
                    ...
                    <div class="col-md-12 my-3">
                        <lable>Address</lable>
                        <input id="placeInput" type="text" name="address" required class="form-control"
                               placeholder="Address">
                    </div>
            ...
            <div class="col-12 text-right">
                <button id="submit_btn" class="btn btn-dark my-4 " type="submit" disabled>Continue to pick up detail
                </button>
            </div>
        </div>
        ...
        @section('js')
            <script
                src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA8LG6Js3S4yieiAfNJbIk3IW0S-aNDTOw&libraries=places&callback=initAutocomplete"
                async></script>
            <script>
