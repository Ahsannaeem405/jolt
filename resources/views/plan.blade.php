...
@section('content')
    ...
    <div class="row my-4">
        ...
        <div class="col-12">
            ...
            <p>With bike theft on the rise in many urban areas, we strongly advise you protect yourself with loss cover.
                75% of Zoomo riders have some level of cover. Select one tier of loss cover to protect yourself against
    ...
    <div class="row my-4">
        ...
        <div class="col-md-4 ">
            <div class="col-12 mt-4">
                <div class="card" >
                    <img class="card-img-top" src="https://cdn.sanity.io/images/hdjyi1x3/production/d2b67ea85f2af1092d843da880b001d9e88a04d8-750x520.png" alt="Card image cap">
                    <div class="card-body">
